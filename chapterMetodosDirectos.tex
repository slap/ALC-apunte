...
En particular, a través de Gramm-Schmidt hemos conluído que toda matriz $\Ab\in \K^{n\times n}$ invertible (en particular con todas sus columnas l.i.) puede factorizarce como una ortogonal $\Qb$ por una triangular superior $\Rb$
$$
\Ab=\Qb\Rb,
$$
