...
\section{Ortogonalidad en Métdos Directos}
...
Notemos que en caso de que $\Qb$ resulte cuadrada ($\Qb\in \K^{n\times n}$), será una matriz unitaria (ortogonal en caso de ser una matriz real). Antes de continuar conviene observar ciertas propiedas de las matrices unitarias.
