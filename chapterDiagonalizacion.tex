...
Para el caso general, $\Ab\in \R^{n\times n}$ no necesariamente simétrica, obtenemos una fórmula levemente más compleja.
...
\begin{center}
\includegraphics[scale=1]{pageRank_4paginas.png}
\end{center}
