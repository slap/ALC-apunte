...
\begin{proposicion} Si $\Ab = \Cb^{-1} \Db \Cb$,
\begin{itemize}
...
\begin{proposicion} Para $\Ab$ hermitiana con autovalores $\lambda_1, \dots, \lambda_n$,
\begin{itemize}
...
\begin{proposicion} Si $\Ab$ diagonal,
  $$\Ab=
 \begin{pmatrix}
  \lambda_1&0&0&\dots&0\\
...
%%$$
%%\begin{aligned}
%%\vb_1^{(k)} &= \left(\frac{\lambda_2}{|\lambda_2|}\right)^k \frac{a_1 \left(\frac{\lambda_1}{\lambda_2}\right)^k \wb_1 + a_2   \wb_2 + a_3 \left(\frac{\lambda_3}{\lambda_2}\right)^k \wb_3+ \dots + a_n \left(\frac{\lambda_n}{\lambda_2}\right)^k \wb_n}{\left\|a_1 \left(\frac{\lambda_1}{\lambda_2}\right)^k \wb_1 + a_2   \wb_2 + a_3 \left(\frac{\lambda_3}{\lambda_2}\right)^k \wb_3+ \dots + a_n \left(\frac{\lambda_n}{\lambda_2}\right)^k \wb_n\right\|_2} \\
%%\vb_2^{(k)} &= \left(\frac{\lambda_2}{|\lambda_2|}\right)^k \frac{b_1 \left(\frac{\lambda_1}{\lambda_2}\right)^k \wb_1 + b_2   \wb_2 + b_3 \left(\frac{\lambda_3}{\lambda_2}\right)^k \wb_3+ \dots + b_n \left(\frac{\lambda_n}{\lambda_2}\right)^k \wb_n}{\left\|b_1 \left(\frac{\lambda_1}{\lambda_2}\right)^k \wb_1 + b_2   \wb_2 + b_3 \left(\frac{\lambda_3}{\lambda_2}\right)^k \wb_3+ \dots + b_n \left(\frac{\lambda_n}{\lambda_2}\right)^k \wb_n\right\|_2} \\
%%\end{aligned}
%%$$
$$
\begin{aligned}
...
\begin{observacion} $\{\tilde \ub_1^{(k)}, \tilde \ub_2^{(k)} \}$ es el resultado de aplicar Gram-Schmidt a $\{\vb_1^{(k)}, \vb_2^{(k)} \}$.
\end{observacion}
...
%\KwResult{Write here the result }
 \For{$k = 1, 2, \dots$}{
$\tilde \Bb^{(k)} = \Ab \Bb^{(k-1)}$\;
$\tilde \Bb^{(k)} = \Qb^{(k)} \Rb^{(k)}$, descomposición $QR$ de $\tilde \Bb^{(k)}$\;
$\Bb^{(k)} = \Qb^{(k)}$, el resultado de aplicar G-S a las columnas de $\tilde \Bb^{(k)}$
 }
...
\For{$k = 0, 1, 2, \dots$}{
Calcular la descomposición $QR$ de $\Ab^{(k)}$, $\Ab^{(k)} = \Qb^{(k)} \Rb^{(k)}$ \;
$\Ab^{(k+1)} = \Rb^{(k)} \Qb^{(k)}$
}
 \caption{Método QR}
\end{algorithm}
...
\begin{observacion} La matriz que se obtiene en cada paso es semejante a la matriz del paso anterior:
$$
...
\begin{teorema} Todos los autovalores de $\Ab$ están en alguno de los discos de Gershgorin $D(a_{ii}, R_{i})$.
\end{teorema}
