...
\include{chapterEspaciosVectoriales}
\include{sectionMatrices}
\include{chapterTransformaciones}
\include{chapterNumerosMaquina}
          %%ojo cambie el nomre no es ProductoInterno
\include{chapterProdInterno}
\include{chapterMetodosDirectos}
\include{chapterDiagonalizacion}
          %\include{chapterFactorizacion}
\include{chapterMetodosIterativos}
\include{chapterSVD}
